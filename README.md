🛴 Urban Scooter – Proyecto Final de Testing
...
Proyecto final del sprint de Urban Scooter, enfocado en aplicar de forma práctica técnicas de testing profesional:

UI, móvil y API testing

Diseño de pruebas con clases de equivalencia, valores límite y tablas de decisión

Validación de funcionalidades críticas: pedidos, notificaciones, cancelaciones y conectividad

Gestión de datos con bases de datos SQL

📂 Estructura del Proyecto
urban-scooter-testing/
│
├── docs/                 # Documentación de pruebas
├── api-tests/            # Casos de prueba de API
├── mobile-tests/         # Casos de prueba de aplicación móvil
├── sql-scripts/          # Consultas SQL y scripts
├── ui-tests/             # Casos de prueba de interfaz
...
Herramientas de Testing: Postman, emuladores móviles, pruebas manuales UI
...
Autor: Pablo
Proyecto: Urban Scooter – Sprint Final
